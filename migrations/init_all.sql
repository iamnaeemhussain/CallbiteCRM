-- ====================================================================
-- CALLBITE ESIM — COMPLETE DATABASE INITIALIZATION & SAMPLE SEED DATA
-- Copy and paste this ENTIRE block into Cloudflare D1 Console & click Execute!
-- ====================================================================
...
-- 2. SEED STAFF USERS & ADMIN ACCOUNTS
...
-- 3. ESIM ROAMING PROVIDERS & CARRIERS
...
-- 4. ESIM PACKAGES & BUNDLES (PKR PRICING)
...
-- 6. CUSTOMER DIRECTORY (15 CUSTOMERS)
